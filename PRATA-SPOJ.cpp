// This is a CP problem based on Binary Search so ia have provided the source code for this proble || Source - SPOJ(Platform) || Google CodeJam Problem
...
//Solution try the above test cases for the below code
